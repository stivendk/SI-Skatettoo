 ...
 */
package com.skatettoo.frontend.attachments;
...
public class Alerts extends MessagesRenderer{
    ...
    private void encodeSeverityMessages(FacesContext facesContext, UIComponent component, UIMessages uiMessages, Severity severity, List<FacesMessage> messages) throws IOException {
        ...
        writer.writeAttribute("class", "alert " + alertSeverityClass + " alert-global", "alert " + alertSeverityClass);
        writer.writeAttribute("role", "alert", "alert");
        writer.startElement("i", component);
        writer.writeAttribute("class", "fa fa-close cerrar-alerta", "class");
        writer.writeAttribute("onclick", "this.parentElement.style.display = 'none'", "onclick");
        writer.endElement("i");
